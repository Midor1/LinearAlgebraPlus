...
public class Main2Activity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        else if(v.getId()==R.id.main2More) {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (options[which]) {
                        case "求矩阵的行列式的值":
                            ...
                            Toast.makeText(Main2Activity.this, "矩阵行列式的值为" + Double.toString(ans), Toast.LENGTH_SHORT).show();
                            break;
                        case "求转置矩阵":
                        ...
                        case "求伴随矩阵":
                            ...
                            bundlE.putDoubleArray("matrix10",an[0]);
                            bundlE.putDoubleArray("matrix11",an[1]);
                            intenT.putExtras(bundlE);
                            This.startActivity(intenT);
                            break;
                        case "求逆矩阵":
                            double anss = matrix[0][0] * matrix[1][1] - matrix[1][0] * matrix[0][1];
                            if(anss==0.0) {
                                Toast.makeText(Main2Activity.this, "矩阵不可逆" , Toast.LENGTH_SHORT).show();
                                break;
                            }
                            double ann[][] = new double[2][2];
                            ann[0][0] = matrix[1][1];
                            ann[0][1] = -matrix[1][0];
                            ann[1][0] = -matrix[0][1];
                            ann[1][1] = matrix[0][0];
                        ...
                        case "将矩阵化为阶梯形":
                            ...
                            break;
                        case "求矩阵的秩":
                            Toast.makeText(Main2Activity.this, "矩阵的秩为" + Integer.toString(Rank(matrix,-1,2)) , Toast.LENGTH_LONG).show();
                            break;
                        case "求矩阵的特征值":
                            double resu[][] = new double[2][2];
                            EigenValue(matrix,2,800,12,resu);
                            Toast.makeText(Main2Activity.this, "矩阵的特征值分别为" + "\n" + Double.toString(resu[0][0]) + "\n" + Double.toString(resu[1][0]) , Toast.LENGTH_LONG).show();
                            break;
                    }
                }
            });
