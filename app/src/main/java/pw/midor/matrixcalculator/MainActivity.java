                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (options[which]) {
                        case "求矩阵的行列式的值":
                            ...
                            double ans = matrix[0][0]* SubMatrix(0,0,matrix)-matrix[0][1]* SubMatrix(0,1,matrix)+matrix[0][2]* SubMatrix(0,2,matrix)-matrix[0][3]* SubMatrix(0,3,matrix);
                            Toast.makeText(MainActivity.this, "矩阵行列式的值为" + Double.toString(ans), Toast.LENGTH_SHORT).show();
                            break;
                        case "求转置矩阵":
                            ...
                            bundle.putDoubleArray("matrix13",b[3]);
                            intent.putExtras(bundle);
                            This.startActivity(intent);
                            break;
                        case "求伴随矩阵":
                            double an[][] = new double[4][4];
                            for(int i=0;i<4;i++)
                                for(int j=0;j<4;j++)
                            ...
                            bundlE.putDoubleArray("matrix13",a[3]);
                            intenT.putExtras(bundlE);
                            This.startActivity(intenT);
                            break;
                        case "求逆矩阵":
                            double anss = matrix[0][0]* SubMatrix(0,0,matrix)-matrix[0][1]* SubMatrix(0,1,matrix)+matrix[0][2]* SubMatrix(0,2,matrix)-matrix[0][3]* SubMatrix(0,3,matrix);
                            if(anss==0.0) {
                                Toast.makeText(MainActivity.this, "矩阵不可逆" , Toast.LENGTH_SHORT).show();
                                break;
                            }
                            double ann[][] = new double[4][4];
                            for(int i=0;i<4;i++)
                                for(int j=0;j<4;j++)
                            ...
                            BundlE.putDoubleArray("matrix13",aa[3]);
                            IntenT.putExtras(BundlE);
                            This.startActivity(IntenT);
                            break;
                        case "将矩阵化为阶梯形":
                            ...
                            break;
                        case "求矩阵的秩":
                            Toast.makeText(MainActivity.this, "矩阵的秩为" + Integer.toString(Rank(matrix,-1,4)) , Toast.LENGTH_SHORT).show();
                            break;
                        case "求矩阵的特征值":
                            double resu[][] = new double[4][4];
                            EigenValue(matrix,4,800,12,resu);
                            Toast.makeText(MainActivity.this, "矩阵的特征值分别为" + "\n" + Double.toString(resu[0][0]) + "\n" + Double.toString(resu[1][0]) + "\n" + Double.toString(resu[2][0]) + "\n" + Double.toString(resu[3][0]) , Toast.LENGTH_SHORT).show();
                            break;
                    }
                }
            });
